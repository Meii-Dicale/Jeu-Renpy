...
define config.name = _("Happy Birthday")
...
define gui.about = _p(""" Tu lis jamais les notices de jeu, tu lis jamais les notices de meubles , mais t'es quand même venu voir jusqu'ici !!!
""")
...
define build.name = "HappyBirthday"
...
define config.main_menu_music = "aurora.mp3"
...
define config.save_directory = "testttt-1705179351"
...
define config.window_icon = "gui/tri.png"
